    ...
    def recv(self, buffer_size):
        ...
        try:
            ...
            if not data:
                ...
                print("новая дата пошла ГОЛДИН",data)
                return data
        except socket.error as err:
...
class AsyncChat(Dispatcher):
    ...
    def handle_read(self):
        ...
        self._input_buffer = b'' #добавил это теперь проблема сraise ValueError('Unable to dispatch data: %r', data)
        #ValueError: ('Unable to dispatch data: %r', b'R|9|^Charge type^^01015|||^|^^^^^^\r\x1783\r\n')
